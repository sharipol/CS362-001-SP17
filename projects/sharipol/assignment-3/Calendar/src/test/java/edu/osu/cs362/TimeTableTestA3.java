...
public class TimeTableTest {
	...
	public void test03()  throws Throwable  {
		...
		assertEquals("\t --- 4/11/2017 --- \n" +
				" --- -------- Appointments ------------ --- \n" +
				"\t4/11/2017 at 3:30pm ,Birthday Party, This is my birthday party.\n" +
				" \t4/11/2017 at 3:30pm ,Meeting Today, Meeting with the students.\n" +
				" \n", calDays.get(0).toString());
		
		//Delete an appointment
		LinkedList<Appt> listUpdatedAppts=timeTable.deleteAppt(listAppts, appt2);
		...
		assertEquals("\t --- 4/11/2017 --- \n" +
				...
				"\t4/11/2017 at 3:30pm ,Birthday Party, This is my birthday party.\n" +
				" \n", calDays.get(0).toString());
		assertNotNull(calDays.getFirst().iterator());
	...
	public void test04()  throws Throwable  {
		...
		assertEquals(0, calDays.getFirst().getSizeAppts());
		assertEquals("\t --- 4/11/2017 --- \n" +
				" --- -------- Appointments ------------ --- \n" +
				"\n", calDays.get(0).toString());
	}
