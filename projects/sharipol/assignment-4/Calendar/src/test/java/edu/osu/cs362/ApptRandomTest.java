...
public class ApptRandomTest {
	private static final long TestTimeout = 10000; /* Timeout at 3\10 seconds */
					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if ( methodName.equals("setDescription")) {
						    ...
						    if (newDescription == null) {
					   	    ...
					   	    int newStartHour = ValuesGenerator.getRandomIntBetween(random, -10, 30);
					   	    appt.setStartHour(newStartHour);
						    boolean bool = appt.getValid();
					   	    if (bool == false){
						   ...
						   int newStartMinute = ValuesGenerator.getRandomIntBetween(random, -10, 70);
						   ...
						   int newStartDay = ValuesGenerator.getRandomIntBetween(random, -10, 40);
						   ...
						   int newStartMonth = ValuesGenerator.getRandomIntBetween(random, 1, 20);
						   appt.setStartMinute(newStartMonth);
						   boolean bool = appt.getValid();
						   if (bool == false){
							   assertFalse(appt.getValid());
						   }
